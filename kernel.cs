...
namespace laba_2
{
    internal class Strategy
    {
        ...
        public void Print()
        {
            strategy.ForEach(i =>
            {
                Console.Write(i == double.MaxValue ? " 0 " : $" {i} ");
            });
            Console.WriteLine();
        }
    }
    ...
    internal class Kernel
    {
        ...
        {
            return StrategyMatrix == obj as List<Strategy>;//base.Equals(obj);
        }
        ...
        public void Print() => StrategyMatrix.ForEach(strategy => strategy.Print());
        ...
        public Strategy this[int index]
        {
            get
            {
                return StrategyMatrix[index];
            }
            set
            {
                StrategyMatrix[index] = value;
            }
        }
